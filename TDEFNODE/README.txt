...
See DEF_2_TDEF.txt for help converting from DEFNODE to TDEFNODE.
...
2. If this is a new installation, rename tdefcom1.h.tmp to tdefcom1.h, If you already have tdefcom1.h in a previous version, you can use it.

3. Set array dimensions within 'tdefcom1.h'. The dimensions are set in a fortran PARAMETER statement and all start with MAX_ . 
...
4. {Optional} Set paths to the volcanoes (votw.gmt; needed if +vtw flag set) and 
...
5. Edit the Makefile to your compiler specifications.

6. Run 'make' to compile. Success depends on your compiler.
